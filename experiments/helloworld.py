...
# %%
from utils.logging import patch_cutlass_loggers
from utils.mlir_pipeline import dump_mlir_pipeline

patch_cutlass_loggers(log_to_console=True)
...
pipeline_opts = [KeepCUBIN, KeepPTX, GenerateLineInfo]
dump_mlir_pipeline(dump_dir="hello_world_mlir_dump")
compiled = cute.compile[*pipeline_opts](hello_world) # ruff: noqa
