                                   ...
                                   Alpha const alpha, Beta const beta)
{
  ...
  TiledMMA tiled_mma = make_tiled_mma(SM90_64x128x16_F16F16F16_SS<GMMA::Major::K,GMMA::Major::K>{});  // A and B layouts
  ...
  auto sA_layout = UMMA::tile_to_mma_shape(GMMA::Layout_K_SW128_Atom<TypeA>{}, mma_shape_A);
  auto sB_layout = UMMA::tile_to_mma_shape(GMMA::Layout_K_SW128_Atom<TypeB>{}, mma_shape_B);
