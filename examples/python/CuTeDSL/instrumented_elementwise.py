...
def run_elementwise_add(
    ...
    tracer_kwargs = dict(
        include_files=["/home/jeromeku/cutlass/cute_dsl/nvidia_cutlass_dsl/python_packages/cutlass/"],
        ignore_frozen=True,
        ignore_c_function=True,
        log_func_args=True,
        log_func_retval=True,
        dump_raw=False,
        output_file="viztrace.elementwise.json"
    )

    with viztracer.VizTracer(**tracer_kwargs) as tracer:
