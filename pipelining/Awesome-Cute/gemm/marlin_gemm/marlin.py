# reference https://github.com/IST-DASLab/marlin/blob/master/marlin/__init__.py
import numpy as np
import torch
...
class Layer(nn.Module):
    ...
    def __init__(self, infeatures, outfeatures, groupsize=-1, cute_version=True):
        ...
        self.cute_version = cute_version
    ...
    def forward(self, A):
        ...
        mul(A.view((-1, A.shape[-1])), self.B, C.view((-1, C.shape[-1])), self.s, self.workspace, self.cute_version)
        return C
