...
namespace
{
      ...
      at::Tensor &out)
  {
    ...
    using GemmKernel = std::conditional_t<
        ...
        groupedmm_ext::enable_3x_kernel_for_sm10<GemmKernelBase>,
        groupedmm_ext::enable_3x_kernel_for_sm9x<GemmKernelBase>>;
    ...
    groupedmm_ext::prepare_grouped_gemm_data<<<1, group_count, 0, stream>>>(
...
void bf16bf16_grouped_mm(
    ...
    at::Tensor &out)
{
  printf("Calling bf16 kernel with shapes: ");
  std::cout << mat_a.sizes() << ", " << mat_b.sizes() << ", " << out.sizes() << "\n";
