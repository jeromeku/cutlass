...
def _cross_entropy(
    ...
    if compile_key not in _cross_entropy.compile_cache:
        ...
        _cross_entropy.compile_cache[compile_key] = compiled_kernel = cute.compile(
    ...
    return cross_entropy_op, compiled_kernel
...
if __name__ == "__main__":
    ...
    ce_op, ce_kernel = _cross_entropy(x, target=target)
    with open('ce_module.mlir', 'w') as f, contextlib.redirect_stdout(f):
        ce_kernel.ir_module.dump()
